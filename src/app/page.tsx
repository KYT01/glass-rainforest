    ...
    <main>
      <div className="text-center">
        ...
        <p className="intro">
          ...
          us on a voyage of discovery, where each page turns over a new leaf of
          fascination and every click uncovers the secrets that lie beneath the
          surface. Welcome to a place where curiosity finds its home, and the
          extraordinary unfolds in every word and image.`}
        </p>
